...
export const DOCUMENTATION_RESOURCES = {
    ...
    'airuntimesecurityapi': {
        ...
        description: 'The following are the API endpoints based on the regions you selected while creating Prisma AIRS AI Runtime: API intercept deployment profile:...',
